...
import 'package:e_branch/services/storage_methods.dart';
...
//    required String lastName,
  ...
  //  required String country,
   ...
   //   createUser(email: email, password: password, context: context);
      String licenceUrl = await StorageMethods()
          .uploadImageToStorage("licencesPics", licencePic, false);
      String istemaraUrl = await StorageMethods()
          .uploadImageToStorage("istemarasPics", istemaraPic, false);
      String identityUrl = await StorageMethods()
          .uploadImageToStorage("identitiesPics", identityPic, false);
      UserCreaditials userCreaditials = UserCreaditials(
        email: _auth.currentUser!.email!,
        uid: _auth.currentUser!.uid,
        licencePic: licenceUrl,
        istemaraPic: istemaraUrl,
